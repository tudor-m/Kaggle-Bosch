...
l = length(Y)
seed_list = list()
seed_list = seq(from=100,to=4000,by=100)
xgb_model_list = list()
threshold_list = list()
...
base1 = 0.50
round1 = 65
xgb_model = deep_xgb(trainX,trainY,validX,validY,seed0,objective0,eta0,md0,mc0,subs0,cols0,base0,round0,seed1=42,pw1,objective1,eta1,md1,mc1,subs1,cols1,base1,round1)
...
## 
dt_ens = 0*predicted_response_total
dt_ens[which(pred_total/20 >= 0.78)] = 1
dt <- data.table(Id=Id,Response = dt_ens)
